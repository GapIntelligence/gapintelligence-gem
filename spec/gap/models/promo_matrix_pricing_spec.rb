...
describe GapIntelligence::PromoMatrixPricing do
  ...
  describe 'attributes' do
    let!(:data) { build(:promo_matrix_pricing, product_version_id: 1, merchant_id: 2, date: '2020-01-01', shelf_price: 100, net_price: 70, promo_value: 30, promo_percentage: 30, on_ad: true, on_promo: false) }
