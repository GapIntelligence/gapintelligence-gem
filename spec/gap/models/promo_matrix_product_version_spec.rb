...
describe GapIntelligence::PromoMatrixProductVersion do
  ...
  describe 'attributes' do
    let!(:data) { build(:promo_matrix_product_version, brand_id: 1, brand_name: 'Brand', part_number: 'Part Number', product_name: 'Product', product_version_id: 2, merchant_id: 3, merchant_name: 'Merchant', image_url: 'http://image.com/1.jpg', specifications: { 'Spec' => 'Value' }) }
